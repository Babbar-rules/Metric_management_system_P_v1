...
const MetricDetail = () => {
    ...
    const { getMetricById, approveMetric, pendingMetrics } = useMetrics()
    ...
    const handleSaveEdit = () => {
        ...
        setMetric(editFormData)
        setIsEditMode(false)
        alert('Metric updated successfully! (Note: In a real application, this would update the database)')
    }
                    ...
                    <div className="detail-section">
                        ...
                        <div className="detail-grid">
                            ...
                            <div className="detail-item">
                                ...
                                <span className="value">{displayMetric.status}</span>
                            </div>
                            <div className="detail-item">
